...
<div class="dashboard-container">
    <aside class="sidebar">
        ...
        <nav class="dashboard-nav">
            <ul>
                <li class="active"><a href="?component=dashboard"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
                <li><a href="?component=users"><i class="fas fa-users"></i> Manage Users</a></li>
                <li><a href="?component=albums"><i class="fas fa-images"></i> All Albums</a></li>
                <li><a href="?component=photos"><i class="fas fa-camera"></i> All Photos</a></li>
                <li><a href="?component=reports"><i class="fas fa-flag"></i> Reports</a></li>
                <li><a href="?component=settings"><i class="fas fa-cog"></i> Settings</a></li>
            </ul>
        </nav>
    </aside>
